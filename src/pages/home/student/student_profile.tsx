...
export default function ViewStudent5ProfileDetails() {
  const location = useLocation();
  const profile = location.state;
  const [creeds, setCreeds] = useState<any>(null);

  //   const { getUserDetails } = getStudentDetails();
  useEffect(() => {
    // getDetails();
  }, []);
                  ...
                  {/* <div className="card mt-3">
                    <ul className="list-group list-group-flush">
                      <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span className="text-gray">https://bootdey.com</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 className="mb-0">
                          <svg
                        ...
                        <span className="text-gray">bootdey</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 className="mb-0">
                          <svg
                  ...
                  <div className="card mb-3">
                    <div className="card-body">
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-9 text-gray">{creeds.email}</div>
                      </div>
                      <hr />
                      <div className="row">
                        <div className="col-sm-3">

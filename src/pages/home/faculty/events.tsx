    ...
    const tablesStructure: Columns[] = [
        ...
        
        {
          ...
          dataFilter: (data: any, key: any) => {
            if(data[key]!=""){
              return(
                <><a className="border border-primary text-primary" style={{borderRadius: "5px", padding: "3px 15px", fontWeight: "600", border: "2px solid 0082C1 !important"}} href={data[key]} target="_blank">View</a></>
              )
            } 
          },
        },
